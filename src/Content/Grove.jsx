...
const locations = [
    ...
    },
    {
        ...
        descriptions: [
            ...
            "The first time a creature views the circle, they must succeed o na DC 15 Charismas saving throw. On a failed save, the target is replaced by a nalfeshnee and transported to the abyssal plan, where they are encased in a block of ice with 400 hit points. The transported creature will remain trapped there until the nalfeshnee is banished or killed. Dispelling the circle at 7th level will also banish the nalfeshnee"
        ]
    },
    {
        location: "E12: Prayer Site of Sehanine",
        descriptions: [
            "READ: The corridor leading the the next chamber dotted with trees and pools of water. The walls are covered in vines of green ivy interspersed with colorful flowers. Part of the cavern is open to the sky. In the middle of the cavern is a sphere of pale light surrounding a crystal pedestal, upon which rests a golden pendant attached to a fine golden chain.",
