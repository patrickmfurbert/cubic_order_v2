...
const locations = [
    ...
    },
    {
        ...
        descriptions: [
            "READ: The underwater passage makes you feel cramped and clostrophobic as you make your way through the eerie depths, the passage suddenly takes a disorienting turn. It starts to slope upwards at an impossible angle, transforming into a vertical shaft that defies all natural laws. You find yourself swimming against the pull of gravity, which adds to the eerie and unsettling atmosphere of this underwater journey. The corridor's surfaces remain slick and covered with strange, bioluminescent organisms, casting an eerie, ethereal glow that provides the only source of illumination. The water's pressure lessens as you ascend, and a sense of anticipation fills your every stroke, as if you're moving against the current of some hidden malevolence. As you continue to swim upward, the oppressive darkness begins to recede, and the water's temperature gradually becomes less frigid. The feeling of unseen eyes observing your ascent lingers, heightening your unease. Finally, after a seemingly endless ascent, you reach the chamber concealed within the abyss. Miraculously, the water surrounding you transitions into air, and you break through the surface, gasping for breath in the pocket of stale, ancient atmosphere. The chamber is illuminated by eerie, flickering torches, casting elongated shadows on the damp, mossy stone walls.",
    ...
    {
        location: "E11.5: Tomb of the Forgotten - Chamber A",
        descriptions: [
            "(READ) A strong necrotic scent hangs in the air, and dense clouds of dust whirl in the darkness ahead. The floor cracks and crunches with each footfall - a busted skull here, a wrist bone there - and you get the distinct impression the entire room is littered with long-dead corpses. Some areas of the floor look hollowed out: deep trenches you instinctively sense you should avoid. A central dais ringed with six columns supports an ornate onyx tomb, which glistens as if covered in moisture. The room itself is as dry as the bones you're standing on. Beyond this chamber, a faint red glow emanates from a smaller room to the side",
            "A sacred burial chamber for an ancient evil, this crypt is a common haunt for cultist hoping to harness a fraction of the power of the Tomb of the forgotten. The floors of both chambers are covered with bones. There are large bone filled holes in the area (1, 2, and 3), 40ft deep. The onyx tomb(4) has an aura of necromancy surrounding it, while the ritual circle(5) gives off an aura of conjuration ",
            "The onyx tomb. This large coffin ahs a heavy lid. The lid is trapped. Any living creature that attempts to lift the lid must succeed on a DC 17 Constituion saving throw at disadvantage, taking 8d8 necrotic damage on a failed save. If this damage reduces the creature to 0 hit points, it dies, rising as a zombie under the control of the vampire in the tomb.",
        ]
    },
    {
        location: "E11.5: Tomb of the Forgotten - Chamber B",
        descriptions: [
            "(READ) You enter this intimate room off the main chamber and feel colder, your breath visible with each exhalation. The floor is covered in ancient runes forming a circle, glowing with a crimson radiance illuminating the skeletons that cling to the walls here. A small door leads to a norrow corridor",
            "The first time a creature views the circle, they must succeed o na DC 15 Charisma saving throw. On a failed save, the target is replaced by a nalfeshnee and transported to the abyssal plan, where they are encased in a block of ice with 400 hit points. The transported creature will remain trapped there until the nalfeshnee is banished or killed. Dispelling the circle at 7th level will also banish the nalfeshnee"
        ]
    },
    {
        location: "E11.5: Tomb of the Forgotten - Cooridoor",
        descriptions: [
            "(READ) Step into the dimly lit corridor, a barren passageway that stretches into the obscurity of the unknown. The air is dry, heavy, and still, carrying a subtle scent of age and abandonment. The walls, coated with a layer of dusky, forgotten memories, are devoid of decoration or adornment. Shadows dance with the feeble light, casting elongated, ghostly forms upon the cold, unyielding floor. At the corridor's end, a heavy, imposing door stands sentinel, its surface laden with centuries of dust and neglect. The door's dark wood, weathered and worn, bears the weight of its own history. An ornate, rusted lock secures its secrets, the keyhole a gateway to what lies beyond, remaining steadfastly impenetrable. On a weathered stone altar positioned before the door rests a solitary book, a tome of intrigue in this desolate place. The leather-bound volume is old and cracked, its once elegant embossing now faded and barely legible. Most pages within are empty, echoing the passage of time. But one page stands apart, bearing a single poem written in elegant, sweeping script. The words seem to shimmer with an otherworldly glow, as if touched by the fingers of forgotten poets:",
            ...
            "Answer: \"your nose\"",
            "When someone states that the answer to the riddle is their nose, they will feel a slightly painful itchy sensation in one of their nostrils. Forcing a sneeze or reaching into their nose reveals a tiny brass key that unlocks the door.",
        ]
    },
    {
        location: "E12: Prayer Site of Sehanine",
        descriptions: [
            "READ: The door opens to the next chamber dotted with trees and pools of water. The walls are covered in vines of green ivy interspersed with colorful flowers. Part of the cavern is open to the sky. In the middle of the cavern is a sphere of pale light surrounding a crystal pedestal, upon which rests a golden pendant attached to a fine golden chain.",
